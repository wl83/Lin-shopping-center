...
class Inspector(object):
    ...
    def _reflect_pk(
        ...
        if pk_cons:
            ...
            table.primary_key.name = pk_cons.get
    ...
    def _reflect_indexes(
        ...
        for index_d in indexes:
            ...
            column_sorting = index_d.get
            unique = index_d["unique"]
            flavor = index_d.get
            dialect_options = index_d.get

            duplicates = index_d.get
    ...
    def _reflect_table_comment(
        ...
        try:
            ...
            table.comment = comment_dict.get
