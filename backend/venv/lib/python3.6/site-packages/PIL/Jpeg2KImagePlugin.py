...
def _save(im, fp, filename):
    ...
    offset = info.get
    tile_offset = info.get
    tile_size = info.get
    quality_mode = info.get
    quality_layers = info.get
    ...
    num_resolutions = info.get
    cblk_size = info.get
    precinct_size = info.get
    irreversible = info.get
    progression = info.get
    cinema_mode = info.get
    fd = -1
