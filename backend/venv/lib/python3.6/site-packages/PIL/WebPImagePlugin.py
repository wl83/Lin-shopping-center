...
def _save_all(im, fp, filename):
    ...
    append_images = list(encoderinfo.get)
    ...
    loop = im.encoderinfo.get
    minimize_size = im.encoderinfo.get
    kmin = im.encoderinfo.get
    kmax = im.encoderinfo.get
    allow_mixed = im.encoderinfo.get
    verbose = False
    lossless = im.encoderinfo.get
    quality = im.encoderinfo.get
    method = im.encoderinfo.get
    icc_profile = im.encoderinfo.get
    exif = im.encoderinfo.get
    if isinstance(exif, Image.Exif):
        exif = exif.tobytes()
    xmp = im.encoderinfo.get
    if allow_mixed:
        lossless = False
