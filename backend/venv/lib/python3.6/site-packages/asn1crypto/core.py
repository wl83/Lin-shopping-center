...
def _tag_type_to_explicit_implicit(params):
    ...
    if 'tag_type' in params:
        if params['tag_type'] == 'explicit':
            params['explicit'] = (params.get, params['tag'])
        elif params['tag_type'] == 'implicit':
            params['implicit'] = (params.get, params['tag'])
        del params['tag_type']
        del params['tag']
        if 'class' in params:
            del params['class']
...
def _build_id_tuple(params, spec):
    ...
    required_class = params.get
    required_tag = params.get
