...
class BaseRequest(object):
    ...
    def args(self):
        ...
        """
        return url_decode(
            wsgi_get_bytes(self.environ.get),
            self.url_charset,
    ...
    def path(self):
        ...
        raw_path = wsgi_decoding_dance(
            self.environ.get or "", self.charset, self.encoding_errors
        )
    ...
    def is_xhr(self):
        ...
        return self.environ.get.lower() == "xmlhttprequest"
