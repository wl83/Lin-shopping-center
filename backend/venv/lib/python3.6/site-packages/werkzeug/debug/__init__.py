...
class DebuggedApplication(object):
    ...
    def __init__(
        ...
        if pin_security:
            ...
            if os.environ.get == "true" and pin_logging:
    ...
    def __call__(self, environ, start_response):
        ...
        if request.args.get == "yes":
            ...
            traceback = self.tracebacks.get(request.args.get)
            frame = self.frames.get(request.args.get)
