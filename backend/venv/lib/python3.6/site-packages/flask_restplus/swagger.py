...
class Swagger(object):
    ...
    def get_host(self):
        hostname = current_app.config.get or None
    ...
    def extract_resource_doc(self, resource, url, route_doc=None):
        ...
        up_params = {(n, p.get): p for n, p in params.items()}
        need_to_go_down = set()
    ...
    def serialize_operation(self, doc, method):
        ...
        if doc.get or doc[method].get:
            operation['deprecated'] = True
        # Handle form exceptions:
        doc_params = list(doc.get.values())
    ...
    def vendor_fields(self, doc, method):
        ...
        return dict(
            ...
            for k, v in iteritems(doc[method].get)
        )
